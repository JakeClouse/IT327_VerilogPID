...
VL_ATTR_COLD void Vtop_module___024root___eval_initial__TOP(Vtop_module___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.top_module__DOT__integral = 0U;
    vlSelfRef.top_module__DOT__prevError = 0U;
    vlSelfRef.top_module__DOT__pidOut = 0U;
}
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vtop_module___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG
...
#ifdef VL_DEBUG
            Vtop_module___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
#endif
            VL_FATAL_MT("PIDRunner.v", 2, "", "Settle region did not converge after 100 tries");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
    } while (Vtop_module___024root___eval_phase__stl(vlSelf));
}
...
VL_ATTR_COLD bool Vtop_module___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in);

#ifdef VL_DEBUG
VL_ATTR_COLD void Vtop_module___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_module___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vtop_module___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vtop_module___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop_module___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD bool Vtop_module___024root___eval_phase__stl(Vtop_module___024root* vlSelf) {
    ...
    __VstlExecute = Vtop_module___024root___trigger_anySet__stl(vlSelfRef.__VstlTriggered);
    if (__VstlExecute) {
...
VL_ATTR_COLD void Vtop_module___024root___dump_triggers__ico(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    // Body
    if ((1U & (~ (IData)(Vtop_module___024root___trigger_anySet__ico(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
...
VL_ATTR_COLD void Vtop_module___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    // Body
    if ((1U & (~ (IData)(Vtop_module___024root___trigger_anySet__act(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
...
VL_ATTR_COLD void Vtop_module___024root___ctor_var_reset(Vtop_module___024root* vlSelf) {
    ...
    vlSelf->angleIn = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 11469609257004537609ull);
    vlSelf->setPoint = VL_SCOPED_RAND_RESET_I(12, __VscopeHash, 12961291797824835287ull);
    vlSelf->kp = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 471221470549395300ull);
    vlSelf->ki = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 12731887323553496709ull);
    vlSelf->kd = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 13937245023630494211ull);
    vlSelf->clk = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16707436170211756652ull);
    vlSelf->dutyCycleOut = VL_SCOPED_RAND_RESET_I(9, __VscopeHash, 4821314410355377707ull);
    vlSelf->top_module__DOT__error = VL_SCOPED_RAND_RESET_I(13, __VscopeHash, 64302653664926929ull);
    vlSelf->top_module__DOT__prevError = VL_SCOPED_RAND_RESET_I(13, __VscopeHash, 9285421011428921942ull);
    vlSelf->top_module__DOT__proportional = VL_SCOPED_RAND_RESET_I(21, __VscopeHash, 14023212383451458046ull);
    vlSelf->top_module__DOT__integral = VL_SCOPED_RAND_RESET_I(29, __VscopeHash, 9519204084255960542ull);
    vlSelf->top_module__DOT__derivative = VL_SCOPED_RAND_RESET_I(22, __VscopeHash, 9424657372314053842ull);
    vlSelf->top_module__DOT__pidOut = VL_SCOPED_RAND_RESET_I(30, __VscopeHash, 239599856598703274ull);
